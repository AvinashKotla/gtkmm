...
// three views and 3D
    ...
    fixed.add(trackBar);
    fixed.move(trackBar, (X0+SCREEN_WIDTH*PARATIO2+SCREEN_WIDTH*WRATIO+SPACE)*0.6, Y0-20);
    ...
    fixed.add(trackBar2);
    fixed.move(trackBar2, (X0+SCREEN_WIDTH*PARATIO2+SPACE+SCREEN_WIDTH*WRATIO+SPACE)*1.6, Y0+SCREEN_WIDTH*PARATIO2/2);
